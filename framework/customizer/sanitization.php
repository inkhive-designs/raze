<?php
	...
	function raze_sanitize_checkbox( $input ) {
	    if ( $input == 1 ) {
	        return 1;
	    } else {
	        return '';
	...
	function raze_sanitize_positive_number( $input ) {
	...
	function raze_sanitize_category( $input ) {
	...
	function raze_sanitize_product_category( $input ) {
	...
	function raze_sanitize_text( $input ) {
