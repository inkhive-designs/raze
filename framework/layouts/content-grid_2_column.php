...
<article id="post-<?php the_ID(); ?>" <?php post_class('col-md-6 col-sm-6 grid grid_2_column'); ?>>
		...
		<div class="out-thumb col-md-12">
			<header class="entry-header">
				...
				<div class="postedon"><?php raze_posted_on(); ?></div>
				<div class="entry-excerpt"><?php echo substr(get_the_excerpt(),0,200).(get_the_excerpt() ? "..." : "" ); ?></div>
				<div class="readmore"><a class="hvr-underline-from-center" href="<?php the_permalink() ?>"><?php _e('Read More','raze'); ?></a></div>
			</header><!-- .entry-header -->
		</div><!--.out-thumb-->
