 ...
 */
?>
<?php do_action('raze_before-article'); ?>
<article id="post-<?php the_ID(); ?>" <?php post_class('col-md-6 col-sm-6 grid grid_2_column'); ?>>
		...
		<div class="out-thumb col-md-12">
			<header class="entry-header">
				...
				<span class="readmore"><a class="hvr-underline-from-center" href="<?php the_permalink() ?>"><?php _e('Read More','raze'); ?></a></span>
			</header><!-- .entry-header -->
		</div><!--.out-thumb-->
					
</article><!-- #post-## -->
<?php do_action('raze_after-article'); ?>